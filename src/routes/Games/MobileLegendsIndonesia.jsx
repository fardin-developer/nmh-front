...
const code = 'mobile-legends-indonesia'
export default function MobileLegendsIndonesia() {
  ...
  const fetchUserInfo = async () => {
    try {
      ...
      if (result.success) {
        ...
        if (result.data.region == 'others') navigate('/mobile-legends', { state: { ...values, inGameName }, replace: true })
      } else {
