...
import { farlightSchema } from '../../models'
...
export default function MobileLegendsRussia() {
  ...
  const { values, setValues, errors, touched, isSubmitting, handleBlur, handleChange, handleSubmit } = useFormik({
    initialValues,
    validationSchema: farlightSchema,
    ...
    <>
      ...
      <Modal centered show={infomodal} onHide={() => setInfomodal(false)} className='detail-modal'>
        ...
        <Modal.Body className='p-md-4 p-3 pt-0'>
          ...
          <p>To find your User ID, click on your avatar on the top left corner, under Basic Info, you can find your User ID under your Nickname. For example, 123456789. Enter 123456789 in the User ID field</p>
