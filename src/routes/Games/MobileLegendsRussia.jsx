...
const code = 'mobile-legends-russia'
export default function MobileLegendsRussia() {
  ...
  useEffect(() => {
    ...
    if (state) {
      ...
      setValues({ ...values, characterId, serverId, inGameName })
  ...
  const fetchUserInfo = async () => {
    try {
      ...
      if (result.success) {
        ...
        if (result.data.region == 'others') navigate('/mobile-legends', { state: values, replace: true })
        else if (result.data.region == 'indonesia') navigate('/mobile-legends-indonesia', { state: values, replace: true })
      } else {
