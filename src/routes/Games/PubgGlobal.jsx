...
import { pubgmgSchema } from '../../models'
    ...
    <>
      ...
      <Modal centered show={infomodal} onHide={() => setInfomodal(false)} className='detail-modal'>
        ...
        <Modal.Body className='p-md-4 p-3 pt-0'>
          ...
          <p>To find your Player ID, log in to your account in the application. Click on the profile button at the top left corner. For example, 123456789. Enter 123456789 in the Player ID field.</p>
