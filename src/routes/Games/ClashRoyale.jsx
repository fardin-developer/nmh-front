    ...
    <>
      ...
      <Modal centered show={infomodal} onHide={() => setInfomodal(false)} className='detail-modal'>
        ...
        <Modal.Body className='p-md-4 p-3 pt-0'>
          ...
          <p>To find your player tag, open the profile menu at the top left and then copy it. For example: #JLG20Q0P9. Ensure your account is linked to your Supercell ID.</p>
