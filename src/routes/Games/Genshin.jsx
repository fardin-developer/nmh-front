...
import { genshinSchema } from '../../models'
...
export default function MobileLegendsRussia() {
  ...
  const { values, setValues, errors, touched, isSubmitting, handleBlur, handleChange, handleSubmit } = useFormik({
    initialValues,
    validationSchema: genshinSchema,
    ...
    <>
      ...
      <Modal centered show={infomodal} onHide={() => setInfomodal(false)} className='detail-modal'>
        ...
        <Modal.Body className='p-md-4 p-3 pt-0'>
          ...
          <p>
            To find your UID, log in to your account in the application. Click on the profile button at the top left corner. You will find your UID under your avatar. For example, 123456789. Enter 123456789 in the UID field and select the server
            field.
          </p>
